...
import { createEvent } from '../../../redux/provider/actions';
import TimeInput from "../../Common/TimeInput";

export default function AddPatientEventModal({ open, handleClose }) {
            ...
            <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
              <Formik
                ...
                initialValues={{
                  title: "",
                  description: "",
                  startDate: { startDate: format(new Date(), 'yyyy-MM-dd'), endDate: format(new Date(), 'yyyy-MM-dd') },
                ...
                onSubmit={async (values, { setStatus, resetForm }) => {
                  ...
                  let eventParams = {
                    event: {
                      ...
                      start_date_time: new Date(values["startDate"]["startDate"] + " " + values["startTime"]),
                      patient_id: id
                    }
                  }
                          ...
                          <div className="col-span-6 sm:col-span-3">
                            <div className="grid grid-cols-6 gap-1">
                              ...
                              <div className="col-span-2">
                                ...
                                >
                                  {loadingActions.includes("PROVIDER_CREATE_EVENT_ACTION") && <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
